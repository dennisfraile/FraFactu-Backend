...
{
    /// <summary>
    /// DTO para creación de nuevo receptor/cliente
    /// </summary>
    public class CreateReceptorDto
    {
        ...
        // EmisorId se tomará del usuario autenticado (context)
        // No se incluye aquí por seguridad multi-tenant
    }
}
