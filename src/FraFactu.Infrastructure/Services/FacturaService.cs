...
namespace FraFactu.Infrastructure.Services
{
    ...
    public class FacturaService : IFacturaService
    {
        ...
        private readonly IFacturaJobsService _jobsService;
        ...
        public FacturaService(
            ...
            IFacturaJobsService jobsService)
        {
            _context = context;
            _mapper = mapper;
        ...
        public Task<ControlPlazo72hResultadoDto> MarcarDiferidosPorVencer72hAsync(CancellationToken cancellationToken = default)
            => _jobsService.MarcarDiferidosPorVencer72hAsync(cancellationToken);

        public Task<InformeTecnicoContingenciaResultadoDto> DetectarContingenciasParaInformeTecnicoAsync(CancellationToken cancellationToken = default)
            => _jobsService.DetectarContingenciasParaInformeTecnicoAsync(cancellationToken);
