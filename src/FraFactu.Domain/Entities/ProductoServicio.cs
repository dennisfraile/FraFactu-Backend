...
namespace FraFactu.Domain.Entities
{
    ...
    public class ProductoServicio : BaseEntity
    {
        ...
        /// Solo informativo en Smartix; SmartInventory lo usa para devaluar.
        /// </summary>
        public int? AniosVidaUtil { get; set; }

        /// <summary>
        /// Valor neto en libros actual del activo. Arranca igual a
        /// <c>PrecioCosto</c> al adquirirlo. Smartix no actualiza este valor
        /// automaticamente; el job de devaluacion vive en SmartInventory.
        /// </summary>
        public decimal? ValorActual { get; set; }

        /// <summary>
        /// Piso de devaluacion. SmartInventory nunca baja del residual.
        /// Smartix solo lo guarda para enviarlo en el sync.
        /// </summary>
